...
Класс предоставляет два интерфейса для загрузки последовательностей:
...
должна контролировать целостность данных до окончания вызова.
Для получения результатов распознавания следует использовать метод getRecord.
